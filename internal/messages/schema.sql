...
CREATE TABLE IF NOT EXISTS fido_binkp_stats (
    ...
    toss_skipped_duplicate     INTEGER NOT NULL DEFAULT 0,
    toss_skipped_hold_failed   INTEGER NOT NULL DEFAULT 0,
    toss_skipped_insert_failed INTEGER NOT NULL DEFAULT 0,
